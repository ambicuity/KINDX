...
// Reproduce the filterByCollections logic from kindx.ts for testing
// (the function is private in kindx.ts)
...
describe("filterByCollections", () => {
  const results = [
    { filepath: "kindx://docs/readme.md", file: "kindx://docs/readme.md" },
    { filepath: "kindx://notes/todo.md", file: "kindx://notes/todo.md" },
    { filepath: "kindx://journals/2024/jan.md", file: "kindx://journals/2024/jan.md" },
    { filepath: "kindx://docs/api.md", file: "kindx://docs/api.md" },
  ];
  ...
  test("filters to matching collections when multiple specified", () => {
    ...
    expect(filtered.map((r) => r.filepath)).toEqual([
      "kindx://docs/readme.md",
      "kindx://journals/2024/jan.md",
      "kindx://docs/api.md",
    ]);
  });
  ...
  test("uses file field when filepath is missing", () => {
    const fileOnlyResults = [
      { file: "kindx://docs/readme.md" },
      { file: "kindx://notes/todo.md" },
    ];
