...
describe("handelize", () => {
  ...
  test("normalizes virtual paths", () => {
    expect(normalizeVirtualPath("kindx://docs/readme.md")).toBe("kindx://docs/readme.md");
    expect(normalizeVirtualPath("docs/readme.md")).toBe("docs/readme.md");
  });

  test("detects virtual paths", () => {
    expect(isVirtualPath("kindx://docs/readme.md")).toBe(true);
    expect(isVirtualPath("/tmp/file.md")).toBe(false);
  });

  test("parses virtual paths", () => {
    expect(parseVirtualPath("kindx://docs/readme.md")).toEqual({
      collectionName: "docs",
      path: "readme.md",
    });
  });
