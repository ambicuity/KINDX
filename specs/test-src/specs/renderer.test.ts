...
import type { SearchResult, DocumentResult } from "../engine/repository.js";
...
function makeSearchResult(overrides: Partial<SearchResult> = {}): SearchResult {
  return {
    filepath: "kindx://archive/summit/keynote.md",
    displayPath: "kindx://archive/summit/keynote.md",
...
describe("search results include context in all formats", () => {
  ...
  test("MCP CSV format includes context", () => {
    const mcpResults = [{
      docid: "dc5590",
      file: "kindx://archive/summit/keynote.md",
      title: "Summit Keynote",
      score: 0.84,
      context: TEST_CONTEXT,
