...
| Repository | Purpose |
|------------|---------|
| `ambicuity/kindx-query-expansion-1.7B` | Final merged model (SFT baseline) |
| `ambicuity/kindx-query-expansion-1.7B-gguf` | GGUF quantized versions for deployment |
| `ambicuity/kindx-query-expansion-1.7B-sft` | SFT adapter checkpoint (intermediate) |
| `ambicuity/kindx-query-expansion-train` | Prepared training dataset |
| `ambicuity/kindx-query-expansion-1.7B-grpo` | Experimental GRPO adapter (optional) |
