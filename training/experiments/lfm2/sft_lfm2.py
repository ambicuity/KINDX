...
# ///
"""
SFT training for KINDX query expansion with LiquidAI LFM2-1.2B.
...
OUTPUT_MODEL = "ambicuity/kindx-query-expansion-lfm2-sft"
...
# SFT config
config = SFTConfig(
    output_dir="kindx-query-expansion-lfm2-sft",
    push_to_hub=True,
