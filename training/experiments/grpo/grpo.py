...
# ///
"""
GRPO training for KINDX query expansion (Qwen3-1.7B).
...
if not os.path.exists(_eval_common_path):
    ...
    _url = "https://huggingface.co/datasets/ambicuity/hf-cli-jobs-uv-run-scripts/resolve/main/eval_common.py"
...
SFT_MODEL = "ambicuity/kindx-query-expansion-1.7B-sft"
OUTPUT_MODEL = "ambicuity/kindx-query-expansion-1.7B-grpo"
DATASET = "ambicuity/kindx-query-expansion-train"
...
def main():
    ...
    config = GRPOConfig(
        output_dir="kindx-query-expansion-1.7B-grpo",
        push_to_hub=True,
