...
# ///
"""
Convert KINDX query expansion model to GGUF format.
...
PRESETS = {
    ...
    "4B": {
        "base": "Qwen/Qwen3-4B",
        "sft": "ambicuity/kindx-query-expansion-4B-sft",
        "grpo": "ambicuity/kindx-query-expansion-4B-grpo",
        "output": "ambicuity/kindx-query-expansion-4B-gguf",
...
def main():
    parser = argparse.ArgumentParser(description="Convert KINDX model to GGUF")
    ...
    print(f"KINDX GGUF Conversion: {model_name}")
    print("=" * 60)
...
GGUF conversion of the KINDX Query Expansion model.
