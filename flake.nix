{
  description = "KINDX - Quick Markdown Search";
        ...
        qmd = pkgs.stdenv.mkDerivation {
          ...
          installPhase = ''
            ...
            makeWrapper ${pkgs.bun}/bin/bun $out/bin/qmd \
              --add-flags "$out/lib/qmd/engine/kindx.ts" \
          ...
          meta = with pkgs.lib; {
            ...
            homepage = "https://github.com/ambicuity/KINDX";
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "KINDX development shell"
            echo "Run: bun engine/kindx.ts <command>"
          '';
        };
      }
    );
