...
KINDX now runs on both Node.js and Bun, with up to 2.7x faster reranking
...
- Runtime: support Node.js (>=22) alongside Bun. The `kindx` wrapper
...
- **Group by theme, not by file.** "Performance" not "Changes to inference.ts".
