...
KINDX operates under a **Benevolent Dictator for Life (BDFL)** model. This model ensures that decision-making remains focused, agile, and aligned with the project's core mission: providing a high-quality, fully local, on-device document search engine.
...
- Ensuring the architectural integrity and performance of the search engine.
...
While the BDFL retains final say on all project matters, KINDX thrives on community input. Decisions are made transparently through:
