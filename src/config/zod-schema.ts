...
const MemoryKindxSessionSchema = z
  .object({
    enabled: z.boolean().optional(),
...
const MemoryKindxUpdateSchema = z
  .object({
...
const MemoryKindxLimitsSchema = z
  .object({
...
const MemoryKindxMcporterSchema = z
  .object({
    enabled: z.boolean().optional(),
...
const MemoryKindxSchema = z
  .object({
    command: z.string().optional(),
    mcporter: MemoryKindxMcporterSchema.optional(),
    searchMode: z.union([z.literal("query"), z.literal("search"), z.literal("vsearch")]).optional(),
    includeDefaultMemory: z.boolean().optional(),
    paths: z.array(MemoryKindxPathSchema).optional(),
    sessions: MemoryKindxSessionSchema.optional(),
    update: MemoryKindxUpdateSchema.optional(),
    limits: MemoryKindxLimitsSchema.optional(),
...
const MemorySchema = z
  .object({
    backend: z.union([z.literal("builtin"), z.literal("kindx")]).optional(),
    citations: z.union([z.literal("auto"), z.literal("on"), z.literal("off")]).optional(),
    kindx: MemoryKindxSchema.optional(),
  })
  .strict()
  .optional();
