...
function createSlackMediaFetch(token: string): FetchLike {
  ...
  const globalFetch = globalThis.fetch as unknown as { mock?: unknown; preconnect?: unknown };
  if (typeof globalFetch.mock === "object" || typeof globalFetch.preconnect === "function") {
    (wrappedFetch as FetchLike & { preconnect?: () => void }).preconnect = () => {};
  }
  return wrappedFetch;
}
