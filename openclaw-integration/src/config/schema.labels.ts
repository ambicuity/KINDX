...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.kindx.command": "KINDX Binary",
  "memory.kindx.mcporter": "KINDX MCPorter",
  "memory.kindx.mcporter.enabled": "KINDX MCPorter Enabled",
  "memory.kindx.mcporter.serverName": "KINDX MCPorter Server Name",
  "memory.kindx.mcporter.startDaemon": "KINDX MCPorter Start Daemon",
  "memory.kindx.searchMode": "KINDX Search Mode",
  "memory.kindx.includeDefaultMemory": "KINDX Include Default Memory",
  "memory.kindx.paths": "KINDX Extra Paths",
  "memory.kindx.paths.path": "KINDX Path",
  "memory.kindx.paths.pattern": "KINDX Path Pattern",
  "memory.kindx.paths.name": "KINDX Path Name",
  "memory.kindx.sessions.enabled": "KINDX Session Indexing",
  "memory.kindx.sessions.exportDir": "KINDX Session Export Directory",
  "memory.kindx.sessions.retentionDays": "KINDX Session Retention (days)",
  "memory.kindx.update.interval": "KINDX Update Interval",
  "memory.kindx.update.debounceMs": "KINDX Update Debounce (ms)",
  "memory.kindx.update.onBoot": "KINDX Update on Startup",
  "memory.kindx.update.waitForBootSync": "KINDX Wait for Boot Sync",
  "memory.kindx.update.embedInterval": "KINDX Embed Interval",
  "memory.kindx.update.commandTimeoutMs": "KINDX Command Timeout (ms)",
  "memory.kindx.update.updateTimeoutMs": "KINDX Update Timeout (ms)",
  "memory.kindx.update.embedTimeoutMs": "KINDX Embed Timeout (ms)",
  "memory.kindx.limits.maxResults": "KINDX Max Results",
  "memory.kindx.limits.maxSnippetChars": "KINDX Max Snippet Chars",
  "memory.kindx.limits.maxInjectedChars": "KINDX Max Injected Chars",
  "memory.kindx.limits.timeoutMs": "KINDX Search Timeout (ms)",
  "memory.kindx.scope": "KINDX Surface Scope",
  auth: "Auth",
